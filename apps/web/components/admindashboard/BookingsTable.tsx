                                ...
                                <td className="px-6 py-5 whitespace-nowrap">
                                    <div className="flex items-center gap-3">
                                        <div className="w-8 h-8 rounded-lg bg-black flex items-center justify-center p-1 flex-shrink-0">
                                            <img src={booking.brandLogo} alt="" className="w-full h-full object-contain brightness-0 invert"
                                                onError={(e) => {
                                ...
                                <td className="px-6 py-5 whitespace-nowrap">
                                    <div className="flex items-center gap-3">
                                        <div className="w-7 h-7 rounded-full bg-gray-200 overflow-hidden ring-2 ring-white">
                                            <img src={booking.influencerAvatar} alt="" className="w-full h-full object-cover" />
                                        </div>
